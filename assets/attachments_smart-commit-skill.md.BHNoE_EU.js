import{_ as i,c as a,o as n,af as l}from"./chunks/framework.zqhv3A7-.js";const r=JSON.parse('{"title":"附件：Smart Commit Skill 完整内容","description":"","frontmatter":{},"headers":[],"relativePath":"attachments/smart-commit-skill.md","filePath":"attachments/smart-commit-skill.md"}'),h={name:"attachments/smart-commit-skill.md"};function p(k,s,t,E,e,g){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="附件-smart-commit-skill-完整内容" tabindex="-1">附件：Smart Commit Skill 完整内容 <a class="header-anchor" href="#附件-smart-commit-skill-完整内容" aria-label="Permalink to “附件：Smart Commit Skill 完整内容”">​</a></h1><p>这是《AI Coding 时代，失效的不是 Git，而是 Git 工作流》的附件页。</p><p>它不出现在博客菜单里，只能通过文章里的附件链接，或者直接访问当前路由打开。</p><div class="language-md"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;">---</span></span>
