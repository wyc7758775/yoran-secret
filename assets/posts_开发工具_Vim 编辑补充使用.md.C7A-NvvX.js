...
<span class="line"><span>$ defaults delete -g ApplePressAndHoldEnabled</span></span></code></pre></div><p>然后配置系统设置中的键盘 \b 按键重复，和重复前延迟</p><blockquote><p>全部拉到满，会感觉到使用别的东西也非常的丝滑</p></blockquote><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b5b6e43ce3f48ab83f3f33b56d284d6~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>不过这个配置的话还是不够快，可以在终端输入如下命令行：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>defaults write NSGlobalDomain KeyRepeat -int 1</span></span></code></pre></div><blockquote><p>听说 0 是最快的，不过 1 感觉还好</p></blockquote>`,51)]))}const m=a(p,[["render",l]]);export{b as __pageData,m as default};
