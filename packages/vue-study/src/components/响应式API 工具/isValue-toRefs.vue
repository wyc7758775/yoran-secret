...
<template>
  ...
  <p>{{ nameNick }} {{ age }}</p>
  <button @click="handleObjRefs">
    修改objRefs
  </button>
  <p>{{ nameNickReactive }} {{ ageReactive }}</p>
  <button @click="handleObjReactive">
    修改objReactive
  </button>
  <p>{{ color }} {{ isGo }}</p>
  <button @click="handlePropsRefs">
    修改propsRefs
  </button>
  <p>{{ reactiveNameNick }} {{ reactiveAge }}</p>
  <button @click="handleReactiveData">
    修改reactiveData
  </button>
  <p>toRefs(ref): {{ dataToRefs.nameNick }} {{ dataToRefs.age }}</p>
  <button @click="handleDataToRefs">
    修改dataToRefs
  </button>
</template>
